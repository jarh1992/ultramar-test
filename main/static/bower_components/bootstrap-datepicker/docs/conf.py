...
# Adminlte of patterns, relative to source directory, that match files and
...
# Grouping the document tree into LaTeX files. Adminlte of tuples
...
# One entry per manual page. Adminlte of tuples
...
# Grouping the document tree into Texinfo files. Adminlte of tuples
